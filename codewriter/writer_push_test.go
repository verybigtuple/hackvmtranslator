...
func runTestLine(t *testing.T, tc parser.Command, want []string) {
	sb := strings.Builder{}
...
func TestWriterPushConst(t *testing.T) {
	testLine := parser.Command{CmdType: parser.CmdPush, Arg1: "constant", Arg2: 100}
	want := []string{
		"// push constant 100",
		"@100",
		"D=A",
...
func TestWriterPushStatic(t *testing.T) {
	testLine := parser.Command{CmdType: parser.CmdPush, Arg1: "static", Arg2: 5}
	want := []string{
		"// push static 5",
		"@test.5",
		"D=M",
...
func TestWriterPushTempZero(t *testing.T) {
	testLine := parser.Command{CmdType: parser.CmdPush, Arg1: "temp", Arg2: 0}
	want := []string{
		"// push temp 0",
		"@5",
		"D=M",
...
func TestWriterPushTempOne(t *testing.T) {
	testLine := parser.Command{CmdType: parser.CmdPush, Arg1: "temp", Arg2: 1}
	want := []string{
		"// push temp 1",
		"@6", // 5+1
		"D=M",
...
func TestWriterPushLocalZero(t *testing.T) {
	testLine := parser.Command{CmdType: parser.CmdPush, Arg1: "local", Arg2: 0}
	want := []string{
		"// push local 0",
		"@LCL",
		"A=M",
...
func TestWriterPushLocalOne(t *testing.T) {
	testLine := parser.Command{CmdType: parser.CmdPush, Arg1: "local", Arg2: 1}
	want := []string{
		"// push local 1",
		"@LCL",
		"A=M+1",
...
func TestWriterPushLocalTwo(t *testing.T) {
	testLine := parser.Command{CmdType: parser.CmdPush, Arg1: "local", Arg2: 3}
	want := []string{
		"// push local 3",
		"@LCL",
		"A=M+1",
...
func TestWriterPushLocalMore(t *testing.T) {
	testLine := parser.Command{CmdType: parser.CmdPush, Arg1: "local", Arg2: 5}
	want := []string{
		"// push local 5",
		"@5",
		"D=A",
...
func TestWriterPushPointerZero(t *testing.T) {
	testLine := parser.Command{CmdType: parser.CmdPush, Arg1: "pointer", Arg2: 0}
	want := []string{
		"// push pointer 0",
		"@THIS",
		"D=M",
...
func TestWriterPushPointerOne(t *testing.T) {
	testLine := parser.Command{CmdType: parser.CmdPush, Arg1: "pointer", Arg2: 1}
	want := []string{
		"// push pointer 1",
		"@THAT",
		"D=M",
